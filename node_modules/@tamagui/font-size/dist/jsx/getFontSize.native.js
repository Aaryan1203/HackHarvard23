...
const getFontSize = (inSize, opts) => {
  ...
  if (typeof inSize == "number")
    return null;
  const relativeSize = (opts == null ? void 0 : opts.relativeSize) || 0, fontSize = getConfig().fontsParsed[(opts == null ? void 0 : opts.font) || "$body"].size, size = inSize || ("$true" in fontSize ? "$true" : "$4"), sizeTokens = Object.keys(fontSize);
