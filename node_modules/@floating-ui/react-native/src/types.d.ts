...
import type { ComputePositionReturn, Middleware, Placement } from '@floating-ui/core';
export { useFloating } from './';
export type { AlignedPlacement, Alignment, Axis, ClientRectObject, ComputePositionConfig, ComputePositionReturn, Coords, Dimensions, ElementContext, ElementRects, Length, Middleware, MiddlewareArguments, MiddlewareData, MiddlewareReturn, MiddlewareState, Padding, Placement, Platform, Rect, RootBoundary, Side, SideObject, Strategy, } from '@floating-ui/core';
